...
> 지난 4주 경험을 반영해 재조정합니다. 여기 적힌 건 계획일 뿐, 주차가 끝날 때 "실제 한 것"으로 위 섹션에 옮겨 적으세요.

### Week 5 · MVP 다듬기 + 본인 청첩장 실전 테스트

**목표:** 본인 청첩장으로 실제 사용하면서 나오는 실사용 이슈 전부 수정.

- [ ] 실제 사진 10~20장 넣고 갤러리 성능 확인 (이미지 최적화)
- [ ] 실제 하객 3~5명에게 링크 공유 → 피드백 수집
- [ ] 모바일 기기 실기 테스트 (iPhone Safari, 갤럭시 Chrome 등)
- [ ] Lighthouse 점수 체크 (Performance, Accessibility)
- [ ] 메타데이터(OG 이미지, 파비콘) 마무리

**이 주차는 "새 기능 X, 완성도 ↑"에 집중.** 사이드 프로젝트에서 제일 자주 생략되지만 실제 효과가 큰 주차.
...
**의심될 때 질문:** *"이걸 안 하면 v1.0을 공개할 수 없나?"* 답이 NO면 v1.1로 넘기세요.
