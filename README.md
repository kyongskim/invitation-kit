...
전체 후보·우선순위는 [`docs/00-roadmap.md`](./docs/00-roadmap.md#-v11-마일스톤) 참조. 누적 처리 항목: OG 최적화 ✅ · text-primary contrast ✅ · 방명록 본인 삭제 (C' 경로) ✅ · RSVP ✅. 미해결 후보: i18n · App Check · Pretendard dynamic-subset · 본인 삭제 서버 매개 (B 경로) · BGM · Apple Calendar 등
